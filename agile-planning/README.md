...
|---|-------|----------|---------|
| 5 | `agile-5-roadmap` | Roadmap index + MVP/Iteration scope pages | "create the roadmap", "define MVP scope", "plan iterations" |
...
│   ├── 📄 MVP — [Project]          (agile-5; per-sprint detail by agile-9, refined backlog by agile-8, conclusions by agile-15)
