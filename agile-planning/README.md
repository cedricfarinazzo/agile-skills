...
`agile-5-roadmap` also publishes the Roadmap index as a **Claude Code Artifact** — a private, shareable web page stakeholders can read without a Confluence seat, rendering the progress rollup as a real velocity chart instead of a table of dashes.
...
See `skills/agile-8-refinement/docs/sprint-shared-file-audit.md` for full usage.
